 ...
 */
public class ActivityRemoteTracking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remote_tracking);
        try {
            String response = AppSharedPrefrence.getString(ActivityRemoteTracking.this, AppSharedPrefrence.PREF_KEY.USER_PROFILE_INFO);
        ...
        images.add(R.drawable.sim_tracking_slide1);
        images.add(R.drawable.sim_tracking_slide2);

        viewpager = (ViewPager)findViewById(R.id.viewpager);

        adapter = new ViewPagerAdapter(images,ActivityRemoteTracking.this);
