...
public class CheckRecoveryActivity extends AppCompatActivity implements View.OnClickListener,ApiResponseListener {

    private Toolbar toolbar;
    private View submitView;
    private ProgressDialog progressDialog;
    private EditText code;
    private String token = "", codeText, imei;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        setContentView(R.layout.activity_check_recovery);
        ...
        if (toolbar != null) {
            ...
            toolbar.setTitle("Enter Reset-Code or Answer");
    ...
    private void initIds() {
        submitView = findViewById(R.id.btnSubmitCheckRecovery);

        code = (EditText) findViewById(R.id.code_answer);
        toolbar = (Toolbar) findViewById(R.id.toolbarCheckRecovery);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnSubmitCheckRecovery:
    ...
    private boolean validation() {
        ...
        if (codeText.length() == 0) {
            Utility.showToast(this, "Please enter your code/answer");
            return false;
        }
        return true;
    ...
    private void ChangePassword() {
        ...
        ApiCall.getInstance().makePostRequest(this, ApiConstants.API_ADDRESS.CHECK_RECOVERY.path, params, header, this, 101);
            ...
            try {
                ...
                if (jsonObject != null) {
                    ...
                    if(jsonObject.has("response")) {
                        ...
                        Intent check = new Intent(CheckRecoveryActivity.this, RecoverPasswordActivity.class);
...
//            Log.i("response", response);
    ...
    public void onError(String error, int errorCode, int requestCode) {
        ...
        if (error != null) {
            try {
                if (errorCode == 402) {
                    AppSharedPrefrence.clearAllPrefs(CheckRecoveryActivity.this);
                    Intent login = new Intent(CheckRecoveryActivity.this, ActivityLogin.class);
